...
def main():
    ...
    try:
        ...
        if not os.path.exists(db_path):
            print("WARNING: Database not found. Make sure the Discord bot has been run at least once.")
        ...
        if not os.path.exists(config_path):
            print("ERROR: Config file not found. Please make sure config.yaml exists in the data folder.")
            return 1
